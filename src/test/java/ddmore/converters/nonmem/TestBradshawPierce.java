...
import crx.models.Create_BradshawPierce2007;
import eu.ddmore.convertertoolbox.api.response.ConversionDetail;
import eu.ddmore.convertertoolbox.api.response.ConversionDetail.Severity;
import eu.ddmore.convertertoolbox.api.response.ConversionReport;
import eu.ddmore.convertertoolbox.api.response.ConversionReport.ConversionCode;

public class TestBradshawPierce extends TestBase {
	@Before
	public void setUp() throws Exception {
		Create_BradshawPierce2007.main(null);
		inputXMLFile = "../output/BradshawPierce_2007.xml";
		expected_output_file1 = "target/idx_4_simulation.csv";
		init();
	}
